...
fn setup_roundabout_layout(mut commands: Commands) {
    let arm_blueprints = vec![
        ArmBlueprint::from_degrees(0.0, None, 5.0),
        ArmBlueprint::from_degrees(-45.0, None, 5.0),
        ArmBlueprint::from_degrees(-90.0, None, 5.0),
        ArmBlueprint::from_degrees(-180.0, None, 5.0),
        ArmBlueprint::from_degrees(-270.0, None, 5.0),
    ];
    let circle_blueprint = CircleBlueprint::try_new(50.0, 12.5).expect("failed to create");
